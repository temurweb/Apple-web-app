...
export default function Footer() {
  return (
    <div>
      <div className='bg-gray-200 text-gray-600 py-5 md:py-10 px-5 md:px-20 flex justify-center text-[12px]'>
